                        ...
                        page == 2 ? 
                            <React.Fragment>
                                <div className="mb-6">
                                    ...
                                    <input type="text" id="token" name="token"  value={formState.token} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="ex: 000000" required=""/>
                                </div>
                                <button type="button" onClick={handleSubmit} className="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-8 py-4 text-center dark:bg-blue-600 dark:hover:bg-blue-700  text-sm">Check</button>
                            </React.Fragment>
                    :        
                            <React.Fragment>
                                <div className="mb-6">
